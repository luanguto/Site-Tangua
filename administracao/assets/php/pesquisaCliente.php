...
$sqlSelect = "SELECT *, DATE_FORMAT(data_nascimento, '%d/%m/%Y') as data_nascimento FROM formulario_cliente WHERE nome_aluno like '%$cliente%' OR numero_protocolo = '%$cliente%' OR telefone = '%$cliente%'";
