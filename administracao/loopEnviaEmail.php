...
$sql = "SELECT id_cliente, nome_aluno, escola_origem, primeira_unidade_escola, segunda_unidade_escola, numero_protocolo, NE, AV, status_matricula FROM formulario_cliente where status_email = 'Não enviado'";
...
if ($resultado = mysqli_query($conexao, $sql)) {
    ...
    while ($registro = mysqli_fetch_array($resultado)) {
        ...
        if ($registro['NE'] == 'Sim' || $registro['AV'] == 'Sim') {
            $envioDoc = '<p style="color: #627193; font-size: 18px;">ENVIE A DOCUMENTAÇÃO DE COMPROVAÇÃO DO ALUNO: <strong><a href="https://semetangua.com.br/envioDocumentacao.php?link=' . $registroCliente['id_link'] . '">Clique aqui para realizar o envio da documentação</a></strong></p>';
        } else {
            $envioDoc = '';
        }
        ...
        <div style="background-color: #f4f7fc; padding: 1rem">
            ...
            <div style="background-color: #fff; border-radius: 10px; padding: 2rem;">
                ...
                <p style="color: #627193; font-size: 18px;">Escola de Origem: ' . $registro['escola_origem'] . '<strong></strong></p>
                <p style="color: #627193; font-size: 18px;">1º Opção de escola: <strong>' . $registro['primeira_unidade_escola'] . '</strong></p>
                <p style="color: #627193; font-size: 18px;">2º Opção de escola: <strong>' . $registro['segunda_unidade_escola'] . '</strong></p>
                <br>
                ' . $envioDoc . '
                <br>
